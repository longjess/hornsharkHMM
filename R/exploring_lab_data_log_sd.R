...
#' get_dynamic_log_sd_data(old_filename, filename)
...
#' get_static_log_sd_data(old_filename, filename)
...
#' "BigGuy_15Feb18", "Eliza_7Sept17",
#' "Eliza_20Sept17", "Lady_27Mar17")
#' get_dynamic_log_sd_plots(names)
